...
class StageBlock(nn.Module):
    ...
    def __init__(self, depth, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0., drop_path=0., act_layer=gelu, norm_layer='ln'):
        super().__init__()
        self.depth = depth
...
class Discriminator(nn.Module):
    def __init__(self, img_size=32, patch_size=4, in_chans=3, num_classes=1, embed_dim=128, depth=7,
                 num_heads=4, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
